...
function AttachmentContent({ message }: { message: WhatsAppMessage }) {
  ...
  return (
    <a
      ...
      href={objectUrl}
    >
      <svg aria-hidden="true" className="size-5 shrink-0 text-slate-600" fill="none" viewBox="0 0 24 24">
        <path d="M7 3.5h7l4 4v13H7v-17Z" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" />
        <path d="M14 3.5v4h4M9.5 14h5M9.5 17h4" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
      </svg>
  ...
  return (
    <article
      ...
      className={[
        ...
        isOutbound
          ? 'ml-auto border-slate-300 bg-[#eef3f7]'
