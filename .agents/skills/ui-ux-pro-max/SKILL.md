...
The search script is vendored in this project. Invoke it from the repository root:
...
# Step 4: stack guidelines
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "suspense streaming bundle" --stack nextjs
```
