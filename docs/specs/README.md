...
- [`CRM-051`](051-whatsapp-production-media-and-opportunity-lifecycle.md) — Implemented —
  WhatsApp production media correction plus a WhatsApp-only active-Opportunity rule.
